...
function Login() {
    ...
    return (
    <div className='container mx-auto py-32 px-4 min-h-screen dark:bg-slate-800 dark:text-white'>
        <Helmet>
            <title>Login</title>
        </Helmet>
        <section className='flex flex-col justify-center items-center'>
            ...
            <span>Don&apos;t have an account? <Link className='font-semibold dark:text-purple-400 text-purple-800 hover:underline' to={'/signup'}>Sign up</Link></span>
        </section>
        <ToastContainer
